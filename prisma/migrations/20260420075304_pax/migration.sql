...
INSERT INTO "new_SellingPlanOrder" ("createdAt", "customerId", "id", "quantity", "sellingPlanId", "sellingPlanName", "shopifyCustomerId", "title", "totalValue") SELECT "createdAt", "customerId", "id", "quantity", "sellingPlanId", "sellingPlanName", "shopifyCustomerId", "title", "totalValue" FROM "SellingPlanOrder";
